...
public class Usuario {
    ...
    public Usuario(String clave, String password, String nombre, String appat, String apmat, int mPacientes, int mFarmacia, int mBenefactores, int mCtrlEnf, int mInventario, int mPersMed) {
        this.clave = clave;
